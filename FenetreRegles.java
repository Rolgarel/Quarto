...
public class FenetreRegles extends JFrame {
	...
	public FenetreRegles (){
		...
		JLabel l1 = new JLabel (encodeUTF8("2 joueurs, 16 cases, 16 pièces"));
		...
		JLabel l4 = new JLabel (encodeUTF8(" Des rondes et des carrées"));
		...
		JLabel l6 = new JLabel (encodeUTF8("Déroulement de la partie:"));
		l6.setBounds (20,170,450,15);
		l6.setFont (policeText);
		fond.add(l6);
		
		JLabel l7 = new JLabel (encodeUTF8("- Bob désigne une pièce qui n'est pas encore placée pour Yvette"));
		l7.setBounds (20,185,450,15);
		l7.setFont (policeText);
		fond.add(l7);
		
		JLabel l8 = new JLabel (encodeUTF8("- Yvette place cette pièce sur une case vide du plateau"));
		l8.setBounds (20,200,450,15);
		l8.setFont (policeText);
		fond.add(l8);
		
		JLabel l9 = new JLabel (encodeUTF8("- Yvette choisit une pièce qui n'est pas encore placée pour Bob"));
		l9.setBounds (20,215,450,15);
		l9.setFont (policeText);
		fond.add(l9);
		
		JLabel l10 = new JLabel (encodeUTF8("- Bob place cette pièce sur une case vide du plateau"));
		...
		JLabel l12 = new JLabel (encodeUTF8("Pour gagner, il suffit d'être la personne à placer la quatrième pièce"));
		l12.setBounds (20,300,450,15);
		l12.setFont (policeText);
		fond.add(l12);
		
		JLabel l13 = new JLabel (encodeUTF8("d'une ligne, colonne ou diagoanle, où les quatre pièces ont au moins une"));
		l13.setBounds (20,315,450,15);
		l13.setFont (policeText);
		fond.add(l13);
		
		JLabel l14 = new JLabel (encodeUTF8("des caractéristiques citées plus haut en commun (par exemple 4 pièces rondes)."));

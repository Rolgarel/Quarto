/* Classe TestFenetreJeu :
 * Pour générer des plateaux pré-remplis pour résoudre des beugs
 */
...
public class TestFenetreJeu extends JFrame implements ActionListener {
	...
	// Constructeur
	public TestFenetreJeu(Plateau plateauRef, int etape) {
		
		/* Instanciation des variables du jeu */
		jeu = new JeuQuarto(isHuman);
		jeu.plateau = plateauRef;
		this.etape = etape;
   ...
   public void paint(Graphics g){
	...
	public static void main(String[] args) {
		...
		TestFenetreJeu testJeu = new TestFenetreJeu(plateauRef, etape);
	}
